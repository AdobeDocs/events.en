...
If you weren't able to attend the live session - no worries! Review the [slide deck](https://workfront-experience.s3.us-west-2.amazonaws.com/Training/Guides/Customer+Success+at+Scale/100925+-+Fourth+Quarter+Release+Webinar.pdf)  and watch the on-demand recording to follow along.

Also, make sure to review the [release notes](https://experienceleague.adobe.com/en/docs/workfront/using/product-announcements/product-releases/release-25-q4/25-q4-release-overview) on Experience League, as not all features were covered in the webinar.  
