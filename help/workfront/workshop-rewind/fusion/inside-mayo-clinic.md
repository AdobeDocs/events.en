...
Review the [slide deck](https://workfront-experience.s3.us-west-2.amazonaws.com/Training/Guides/Customer+Success+at+Scale/Inside+Mayo+Clinic+-+How+Workfront+Fusion+Helps+the+Humans+Slide+Deck.pdf) and watch the on-demand recording to follow along.

Fusion takes time and practice, so if you're just getting started, learn more about the (free!) [Fusion Training on Experience League](https://experienceleague.adobe.com/en/docs/workfront-learn/tutorials-workfront/fusion/welcome-to-workfront-fusion/workfront-fusion-overview) and don't hesitate to reach out for help from other customers on the [Workfront Fusion Community](https://experienceleaguecommunities.adobe.com/t5/workfront-fusion/ct-p/workfront-fusion-2).
